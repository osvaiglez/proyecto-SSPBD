          ...
          <ul>
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Encargados</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            <label class="block mt-4 text-sm" for="nombre">
              ...
              <label for="tipo" class="block mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400">
                  Tipo de Material
                </span>
                <select type="text" name="tipo" id="tipo" value="{{ old('tipo') ?? $objeto->tipo }}"
              ...
              <label class="block mt-4 text-sm" for="cantidad">
              ...
              <label class="block mt-4 text-sm" for="nombre_almacen">
                ...
                <input type="text" name="nombre_almacen" id="nombre_almacen" value="{{ old('nombre_almacen') ?? $objeto->nombre_almacen }}"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
